# � New Year Memory Vortex

一个基于 React Three Fiber 的 3D 交互式元旦记忆展示项目，通过鼠标交互，让您的珍贵回忆在魔法般的 3D 空间中呈现，迎接 2025 年的到来。
...
- **鼠标交互**：流畅的鼠标控制体验
- **双重视图模式**：
  - **CHAOS 模式**：记忆碎片散落在空间中，回顾过去
  - **VORTEX 模式**：记忆按时间轴排列成漩涡/树形状，展望未来
- **丰富的视觉效果**：金色装饰、粒子特效、后处理效果
- **响应式设计**：适配不同屏幕尺寸
...
- **移动鼠标**：控制光标位置
- **左键点击**：选择/查看照片
- **左键拖拽**：旋转场景（向右拖拽加速顺时针旋转，向左拖拽减速/逆时针）
- **右键拖拽**：平移视角
- **滚轮滚动**：缩放场景
- **双击左键**：在 CHAOS（散落）和 TREE（成树）模式之间切换
