    ...
    return (
        <main className="relative w-full h-screen bg-black text-white overflow-hidden cursor-none">
            ...
            <div className="absolute inset-0 z-10">
                <Suspense fallback={<div className="flex items-center justify-center h-full text-amber-400 cinzel animate-pulse text-2xl">🎉 Loading New Year Magic... ✨</div>}>
                    <Experience />
                </Suspense>
            </div>
            ...
            <div className="absolute inset-0 z-30 pointer-events-none flex flex-col justify-between p-8">
                <header className="flex justify-between items-start">
                    <div>
                        <h1 className="text-4xl md:text-6xl font-bold cinzel text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 drop-shadow-[0_0_20px_rgba(0,255,255,0.5)]">
                            🌌 UrbanComp Memory 🚀
                        </h1>
                        <p className="text-cyan-200/80 cinzel tracking-widest text-sm mt-2">
                            {state === 'CHAOS' ? '✨ DATA FRAGMENTS // SYSTEM INITIALIZING ✨' : '🪐 MEMORY CORE // VORTEX STABILIZED 🪐'}
                        </p>
                    </div>
                </header>
            </div>
